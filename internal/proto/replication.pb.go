...
const file_replication_proto_rawDesc = "" +
	...
	"\x04type\"\xbb\x01\n" +
	"$GetReplicationDestinationInfoRequest\x12G\n" +
	"\x12replication_source\x18\x01 \x01(\v2\x18.proto.ReplicationSourceR\x11replicationSource\x12\x1f\n" +
	"\vsecret_name\x18\x02 \x01(\tR\n" +
	"secretName\x12)\n" +
	"\x10secret_namespace\x18\x03 \x01(\tR\x0fsecretNamespace\"\x7f\n" +
